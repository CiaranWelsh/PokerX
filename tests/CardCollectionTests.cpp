...
TEST_F(CardCollectionTests, TestConstructionFromVector) {
    ...
    cards.push_back(std::make_unique<MockCard>(10, "S"));
    cards.push_back(std::make_unique<MockCard>(4, "S"));
    CardCollection cc(std::move(cards));
    int expected = 2;
    int actual = cc.size();
...
TEST_F(CardCollectionTests, TestStillSortedAfterAddCardInMiddle) {
    std::vector<ICardPtr> cards;
    cards.push_back(std::make_unique<Card>(10, "S"));
    cards.push_back(std::make_unique<Card>(4, "S"));
...
TEST_F(CardCollectionTests, AddCardsFromVector) {
    std::vector<ICardPtr> cards;
    cards.push_back(std::make_unique<Card>(11, "S"));
    cards.push_back(std::make_unique<Card>(5, "S"));
...
TEST_F(CardCollectionTests, TestPopRemovesTopCardFromCollection) {
    ...
    std::vector<ICardPtr> cards;
    cards.push_back(std::make_unique<Card>(6, "C"));
    CardCollection cc(std::move(cards));
...
TEST_F(CardCollectionTests, TestPopWithIntArgReturnValueOfNCards) {
    std::vector<ICardPtr> cards;
    cards.push_back(std::make_unique<Card>(6, "C"));
    cards.push_back(std::make_unique<Card>(7, "H"));
    cards.push_back(std::make_unique<Card>(8, "C"));
...
//    std::vector<ICardPtr > cards1({&mockCards.sixOfClubs, &mockCards.sevenOfClubs});
//    std::vector<ICardPtr > cards2({&mockCards.eightOfClubs, &mockCards.nineOfClubs, &mockCards.tenOfClubs});
...
TEST_F(CardCollectionTests, TestSortCorrectlyOrdersCards) {
    std::unique_ptr<ICard> card1 = std::make_unique<Card>(6, "D");
    std::unique_ptr<ICard> card2 = std::make_unique<Card>(7, "C");
    std::unique_ptr<ICard> card3 = std::make_unique<Card>(8, "H");
    std::unique_ptr<ICard> card4 = std::make_unique<Card>(9, "C");
    std::unique_ptr<ICard> card5 = std::make_unique<Card>(10, "S");
...
TEST_F(CardCollectionTests, TestGetSuitsCallsGetSuit) {
    std::vector<std::unique_ptr<MockCard >> cards1;
    cards1.push_back(std::make_unique<MockCard>(6, "D"));
    CardCollection cc(cards1);
    EXPECT_CALL(*(cards1[0]), getSuit());
    cc.getSuits();
}
//
...
//    MockCard card4(9, "C");
//    MockCard card5(10, "S");
//    std::vector<ICardPtr > cards1({&card1, &card2, &card3, &card4, &card5});
//    CardCollection cc(cards1);
//    ASSERT_EQ(5, cc.size());
//}
//
...
//
//    std::vector<ICardPtr > cards1({&card1, &card2});
//    CardCollection cc(cards1);
...
//
//    std::vector<ICardPtr > cards({&card1, &card2});
//    CardCollection cc(std::move(cards));
...
//    MockCard card1(6, "D");
//    MockCard card2(7, "D");
//    std::vector<ICardPtr > cards1({&card1});
//    CardCollection cc1(cards1);
...
//
//    std::vector<ICardPtr > cards1({&card1, &card2});
//    std::vector<ICardPtr > cards2({&card2, &card3});
//    std::vector<ICardPtr > cards_out;
//
//    CardCollection cc1(cards1);
//    CardCollection cc2(cards2);
...
//
//    std::vector<ICardPtr > cards1({&mockCards.twoOfDiamonds, &mockCards.threeOfClubs});
//    std::vector<ICardPtr > cards2({&mockCards.threeOfClubs, &mockCards.fourOfDiamonds});
//    std::vector<ICardPtr > cards_out;
//
//    CardCollection cc1(cards1);
//    CardCollection cc2(cards2);
...
//    Card card3(2, "H");
//
//    std::vector<ICardPtr > cards1({&card1, &card2, &card3});
//    CardCollection cc1(cards1);
